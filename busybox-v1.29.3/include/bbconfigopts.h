...
"CONFIG_SYSROOT=\"/tc/x64/sysroot\"\n"
"CONFIG_EXTRA_CFLAGS=\"-DANDROID -D__ANDROID__ -D__ANDROID_API__=21 -DSK_RELEASE -nostdlib -march=x86-64 -mtune=atom -fpic -fuse-ld=bfd -Os \"\n"
"CONFIG_EXTRA_LDFLAGS=\"-Xlinker -z -Xlinker muldefs -nostdlib -Bdynamic -Xlinker -dynamic-linker -Xlinker /system/bin/linker64 -Xlinker -z -Xlinker nocopyreloc -Xlinker --no-undefined ${SYSROOT}/usr/lib64/crtbegin_dynamic.o ${SYSROOT}/usr/lib64/crtend_android.o\"\n"
...
"# CONFIG_FEATURE_DATE_SET is not set\n"
